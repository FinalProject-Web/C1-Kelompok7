                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="right">
                                <center><?php echo isset($r_order_fiks['jumlah']) ? $r_order_fiks['jumlah'] : ''; ?></center>
                              </td>
                ...
                <div class="span4">
                  <form action="" method="post">
                    <div class="widget-box">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr class="odd gradeX">
                                ...
                                <td>
                                  <center>
                                    <input id="<?php echo "jumlah" . $r_draft_pesan['id_pesan']; ?>" class="span8" name="jumlah<?php echo $r_draft_pesan['id_masakan']; ?>" type="number" min="1" value="" required placeholder="" onchange="return operasi()" />
                                  </center>
                                </td>
                                <td>
                                  <form action="" method="post">
                                    <button type="submit" value="<?php echo $r_draft_pesan['id_pesan']; ?>" name="hapus_pesan" class="btn btn-danger btn-mini" formnovalidate>
                      ...
                      <br>
                      <center>
                        <button type="submit" value="" name="proses_pesan" class="btn btn-mini btn-info" onclick="return validatePesan()">
                      ...
                      <script>
                        ...
                        function validatePesan() {
                          ...
                          var isPesanValid = false;
                          for (var i = 0; i < pesanan.length; i++) {
                            if (pesanan[i].value > 0) {
                              isPesanValid = true;
                              break;
                            }
                          }
                          ...
                          if (!isPesanValid) {
                            alert('Pilih dan Masukan jumlah pesanan');
                            return false;
                          }
